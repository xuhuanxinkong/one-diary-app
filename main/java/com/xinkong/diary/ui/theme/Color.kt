...
data class DiaryColors(
    ...
    val sweetBackground: Color = SweetWhite,    // FunScreen 背景色
    ...
    val border2: Color = SweetBorder2,
...
val ThemeOcean = DiaryColors(
    ...
    sweetBackground = Color(0xFFBBDEFB),
    sweetText = Color(0xFF0D47A1),
    sweetButton = Color(0xFF90CAF9),
    sweetHighlight = Color(0xFF1976D2),
    sweetPink = Color(0xFF64B5F6),
    sweetPurple = Color(0xFF1E88E5),
    sweetBorder = Color(0xFF42A5F5),
...
val ThemeForest = DiaryColors(
    ...
    sweetBackground = Color(0xFFC8E6C9),
    sweetText = Color(0xFF1B5E20),
    sweetButton = Color(0xFFA5D6A7),
    sweetHighlight = Color(0xFF388E3C),
    sweetPink = Color(0xFF81C784),
    sweetPurple = Color(0xFF43A047),
    sweetBorder = Color(0xFF66BB6A),
...
val ThemeSunset = DiaryColors(
    background = Color(0xFFFFF3E0),
    sweetBackground = Color(0xFFFFE0B2),
    sweetText = Color(0xFFE65100),
    sweetButton = Color(0xFFFFCC80),
    sweetHighlight = Color(0xFFF57C00),
    sweetPink = Color(0xFFFFB74D),
    sweetPurple = Color(0xFFFB8C00),
    sweetBorder = Color(0xFFFFA726),
    border2 = Color(0xFFFF9800),
